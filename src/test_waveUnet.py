...
def main(cfg: DictConfig):
    ...
    waveUnet_model = WaveUNet_PL.load_from_checkpoint(cur_path/Path(ckpt_path))
    ...
    #
    # results = trainer.predict(waveUnet_model, dataloaders=dm_pred)
    #
