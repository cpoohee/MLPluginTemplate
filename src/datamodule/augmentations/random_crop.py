...
from torch_audiomentations.core.transforms_interface import MultichannelAudioNotSupportedException
...
class RandomCrop(torch.nn.Module):
    ...
    # 0.11 version did not include this Random Crop from nightly built
